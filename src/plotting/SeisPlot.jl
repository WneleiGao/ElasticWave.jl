...
function SeisPlot{T<:Real}(d::Array{T,2}; plot_type="TX", style="color",
                           ...
                           ylabel=" ", yunits=" ", labelsize=15, ox=0, dx=1,
                           oy=0, dy=1, xticks="NULL", yticks="NULL", cbar_label="NULL",
                           xticklabels="NULL", yticklabels="NULL", ticksize=15,
    ...
    if (cbar_label != "NULL")
       cb = plt.colorbar()
       cb[:set_label](cbar_label, fontsize=labelsize)
